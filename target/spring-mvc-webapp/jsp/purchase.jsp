<%-- 
    Document   : itemPurchased
    Created on : Aug 9, 2018, 4:21:42 PM
    Author     : Roger Brock
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="col-md-3">
                <form role="form" class="text-center" modelAttribute="total">
                    <div class="form-group">
                        <h2 >Total $ In</h2>
                        <input type="number" class="form-control" path="total"/>
                        <div class="btn-group">
                ...
                <sf:form role="form" method="post" class="text-center">
                    <div class="form-group">
                        <h2>Messages</h2>
                        <input type ="text" class="form-control" />
                        <label for="item" class="col-sm-2"><h4>Item:</h4></label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control form-control-lg" id="item" path="itemNumber"/> 
                        </div>
                        <button type="button" class="btn btn-outline-primary" value="Make Purchase">Make Purchase</button>
                    </div>
                    <hr>
                </sf:form>
                    
                <sf:form role="form" method="post" action="changeReturn" modelAttribute="change" class="text-center">
                    <div class="form-group">
                        <h2>Change</h2>
                        <sf:input type="text" class="form-control" id="change" path="total"/>
                        <div>
