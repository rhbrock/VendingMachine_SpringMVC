<%-- 
    Document   : items
    Created on : Aug 9, 2018, 5:54:37 AM
    Author     : Roger Brock
--%>
        ...
        <div class="container">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <form role="form" method="post" action="makePurchase"  class="text-center">
                        <h2 >Total $ In</h2>
                        <input type="number" class="form-control" name="balance" value="${balance}"/>
                        <div class="btn-group">
                        ...
                        <div class="form-group">
                            <h2>Messages</h2>
                            <input type ="text" class="form-control" id="itemMessage" value="${itemMessage}"/>
                            <label for="item" class="col-sm-2"><h4>Item:</h4></label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control form-control-lg" name="itemNumber" value="${itemNumber}"/> 
                            </div>
                    ...
                    <form role="form" method="get" action="returnMoney"  class="text-center">
                        <div class="form-group">
                            <h2>Change</h2>
                            <input type="text" class="form-control" value="${change}"/>
                            <div>
